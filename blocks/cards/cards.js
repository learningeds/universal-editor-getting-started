...
export default function decorate(block) {
  ...
  // Create carousel dots (pagination)
  ...
  toggleBtn.addEventListener('click', () => {
    ...
    section.classList.toggle('grid-view', !isCarousel);
    section.classList.toggle('carousel-view', isCarousel);

    toggleBtn.textContent = isCarousel ? 'View as grid' : 'View as carousel';

    if (indicatorWrapper) {
      indicatorWrapper.style.display = isCarousel ? 'flex' : 'none';
    }
  ...
  section.classList.add('carousel-view');
